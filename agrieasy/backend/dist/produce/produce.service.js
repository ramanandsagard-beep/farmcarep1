...
let ProduceService = class ProduceService {
    constructor(repo) {
        this.repo = repo;
    }
    list() {
...
exports.ProduceService = ProduceService;
exports.ProduceService = ProduceService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(produce_entity_1.ProduceEntity)),
